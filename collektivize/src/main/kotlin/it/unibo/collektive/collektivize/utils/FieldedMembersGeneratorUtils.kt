...
internal fun generatePrimitivesFiles(origin: List<KCallable<*>>, packageName: String, fileName: String): Sequence<FileSpec> {
    return origin
        ...
        .asSequence()
        .map { (name, functions) ->
            FileSpec.builder(packageName, fileName + name.capitalized()).apply {
                addFileComment("This file is auto-generated by Collektivize. Do not edit it manually.")
                addAnnotation(AnnotationSpec.builder(Suppress::class).addMember("%S,%S", "all", "ktlint").build())
